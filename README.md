...
int main()
{
	...
	while (i > 10);
	printf("TaK как %i не больше 10, цикл выполнил только первую итерацию", i);
	return 0;
}
...
int main()
{
	...
	if(i > 3) 
		...
		printf(”flo всей видимости i равно 2”);
}
```
...
int main()
{
	...
	//во избежание выполнения последующих выражений
		...
		default: 
			//Выполнится, если не найден соответствующий case printf("switch не содержит значение, которому равен i”);
